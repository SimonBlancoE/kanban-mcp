...
export async function startMcpServer(): Promise<void> {
  ...
  console.error("[MCP] Available tools (28 total):");
  ...
  console.error("  Sprint: kanban_sprint_create, kanban_sprint_get, kanban_sprint_update_status, kanban_sprint_list, kanban_sprint_bulk_complete");
